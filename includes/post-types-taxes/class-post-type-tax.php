...
class Post_Types_Taxes {
	...
	public function dependencies() {
		...
		require_once AMCD_PATH . 'includes/post-types-taxes/class-register-post-types.php';

		// Resister cutsom taxonomies.
		require_once AMCD_PATH . 'includes/post-types-taxes/class-register-taxonomies.php';

		// Functions related to post types and taxonomies.
		require_once AMCD_PATH . 'includes/post-types-taxes/class-post-type-tax-functions.php';

		// Drag & drop custom post and taxonomy orders.
		require_once AMCD_PATH . 'includes/post-types-taxes/class-post-type-order.php';
