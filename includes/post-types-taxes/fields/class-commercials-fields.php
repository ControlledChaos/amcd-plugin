	...
	public function fields() {
		...
		if ( function_exists( 'acf_add_local_field_group' ) ) :
			...
			acf_add_local_field_group( [
				...
				'title'  => __( 'Commercials', 'amcd-plugin' ),
				'fields' => [
					[
...
$amcd_plugin_commercials_fields = new Alana_Commercials_Fields;