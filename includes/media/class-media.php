...
namespace AMCD_Plugin\Includes\Media;
...
class Media {
	...
	private function dependencies() {
		...
		include_once AMCD_PATH . 'includes/media/class-svg-support.php';

		// Replace WP gallery shortcode if Fancybox option is used.
		$fancybox = get_option( 'amcd_enqueue_fancybox_script' );

		if ( $fancybox ) {
			require_once AMCD_PATH . 'includes/media/class-gallery-shortcode.php';
		}
	...
	public function rss_featured_images( $content ) {
		...
		$size = apply_filters( 'amcd_rss_featured_image_size', 'medium' );
