...
class Dashboard {
    ...
    public function metaboxes() {
        ...
        || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $hide = get_field( 'amcd_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'amcd_hide_welcome' );
            $gutenberg  = get_option( 'amcd_hide_try_gutenberg' );
            $wp_news    = get_option( 'amcd_hide_wp_news' );
            $quickpress = get_option( 'amcd_hide_quickpress' );
            $at_glance  = get_option( 'amcd_hide_at_glance' );
            $activity   = get_option( 'amcd_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'amcd-plugin' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'amcd-plugin' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once AMCD_PATH . 'partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once AMCD_PATH . 'partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'amcd-plugin' ),
             get_bloginfo( 'name' )
        );
