...
$label       = apply_filters( 'amcd_search_label', esc_html__( 'Search for:', 'amcd-plugin' ) );
$placeholder = apply_filters( 'amcd_search_placeholder', esc_attr( esc_html__( 'Search ', 'amcd-plugin' ) . get_bloginfo( 'name' ) ) );
$submit      = apply_filters( 'amcd_search_submit', esc_html__( 'Submit', 'amcd-plugin' ) );
?>
