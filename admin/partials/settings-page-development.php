...
$page_tabs = apply_filters( 'amcd_tabs_development', $tabs );
...
if ( 'general' == $active_tab ) {
    $section = 'amcd-site-development-general';
    $fields  = 'amcd-site-development-general';
} else {
    $section = null;
    $fields  = null;
}
...
$do_section = apply_filters( 'amcd_section_development', $section );
$do_fields  = apply_filters( 'amcd_fields_development', $fields );
...
<div id="setting-error-settings_updated" class="notice notice-success is-dismissible">
	<p><strong><?php _e( 'Settings saved.', 'amcd-plugin' ); ?></strong></p>
</div>
<?php } ?>
<div class="wrap">
	<?php echo sprintf( '<h1 class="wp-heading-inline">%1s %2s</h1>', get_bloginfo( 'name' ), esc_html__( 'Development', 'amcd-plugin' ) ); ?>
	<p class="description"><?php _e( 'A few tools that come in handy during the development of your website.', 'amcd-plugin' ); ?></p>
