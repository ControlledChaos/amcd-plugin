...
class Users_Callbacks {
	...
	public function block_gravatar( $args ) {
		...
		$option = get_option( 'amcd_block_gravatar' );

		$html = '<p><input type="checkbox" id="amcd_block_gravatar" name="amcd_block_gravatar" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="amcd_block_gravatar"> ' . $args[0] . '</label></p>';
