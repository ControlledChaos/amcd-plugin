...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $options = get_field( 'amcd_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            $links = get_field( 'amcd_links_manager', 'option' );
        } else {
            $links = get_option( 'amcd_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            // Get options.
            $appearance = get_option( 'amcd_hide_appearance' );
            $plugins    = get_option( 'amcd_hide_plugins' );
            $users      = get_option( 'amcd_hide_users' );
            $tools      = get_option( 'amcd_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $menus_link   = get_field( 'amcd_menus_position', 'option' );
            $widgets_link = get_field( 'amcd_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'amcd_menus_position' );
            $widgets_link = get_option( 'amcd_widgets_position' );
